...
namespace Decaf.Backend {
  public static class Codegen {
    ...
    private static WasmExpression CompilePrefixNode(AnfTree.ExpressionNode.PrefixNode node) {
      // TODO: Compile very similarly to `CompileBinopNode`, but with only one operand and different expected signatures
      throw new NotImplementedException("Prefix operators are not yet supported");
    }
